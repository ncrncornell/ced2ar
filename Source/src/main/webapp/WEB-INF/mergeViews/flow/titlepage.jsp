...
<c:set var="js" scope='request'>diff/diff_match_patch merge/mergeTitle2</c:set>

<t:merge>
	<h2>Titlepage Changes</h2>	
			...
			<div class="col-xs-6">
				...
				<div id="mergeButtons">
					...
					<form:form action="${flowExecutionUrl}" method='post'>
						...
						<button type="submit" name="_eventId_endMerge" type="submit" class="btn">
