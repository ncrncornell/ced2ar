...
//TODO: This is a legacy class ported from the old API
public class SearchConstructor {
	...
	private WeakHashMap<String, String> API_DDI_PATH = new WeakHashMap<String, String>();
	private WeakHashMap<String, String> VARNAME_MAPPING = new WeakHashMap<String, String>();
