...
<t:main>
	<c:if test="${git}">
		<a
			...
			class="printButton" title="View versions" aria-label="View versions"> <i class="fa fa-git"></i>
		</a>
	</c:if>
	<a href="${baseURI}/codebooks/${baseHandle}/v/${version}/vars/${var}"
		class="printButton" title="Back to viewing mode"  aria-label="Back to viewing mode">
