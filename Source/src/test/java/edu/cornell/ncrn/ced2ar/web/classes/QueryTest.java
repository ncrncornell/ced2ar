...
import edu.cornell.ncrn.ced2ar.web.classes.Query;

/**
 *Tests the private methods of the Query.java class within the package edu.cornell.ncrn.ced2ar.web.classes
