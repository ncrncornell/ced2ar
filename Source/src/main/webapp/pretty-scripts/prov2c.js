        ...
        function(){
            ...
            for (i = 0; i < len; i++) {
                ...
                if($("#nodeFilterList option[value='"+node.id+"']").length < 1){
                	...
                	$("#inputSelector").append("<option value=\""+node.id+"\">"+node.label+"</option>");
                }
            }	
            ...
            if(viewingSubset){
            	...
            	$("#nodeCount").append(" <br /><a href='"+baseURI+"/edit/prov/"+selectedNode+"'>Edit this node</a>");
            }else{
